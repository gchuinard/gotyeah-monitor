<script lang="ts">
	...
	// Au montage : lit le token du fragment d'URL et confirme le changement d'email
	// (POST /auth/confirm-email-change) ; le résultat pilote l'affichage success/error.
	onMount(async () => {

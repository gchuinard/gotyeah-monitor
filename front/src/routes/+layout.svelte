...
<div
  class="min-h-screen relative overflow-hidden
         bg-gradient-to-br from-[#f4f7ff] via-[#eef3ff] to-white text-slate-900
         dark:bg-gradient-to-b dark:from-[#020617] dark:via-black dark:to-[#020617] dark:text-slate-100"
>
  <div
